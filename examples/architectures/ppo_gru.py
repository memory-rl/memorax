...
from memorax.networks import (FFN, RNN, FeatureExtractor, Network,
...
logger = Logger(
    [DashboardLogger(title="PPO GRU CartPole", total_timesteps=total_timesteps, name="PPO-GRU", env_id="gymnax::CartPole-v1")]
)

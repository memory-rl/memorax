...
from memorax.algorithms import PPOC, PPOCConfig
...
cfg = PPOCConfig(
    ...
    termination_coefficient=0.5,
    option_entropy_coefficient=0.01,
)
...
logger = Logger(
    [DashboardLogger(title="PPOC CartPole", total_timesteps=total_timesteps)]
)

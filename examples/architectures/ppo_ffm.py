...
from memorax.networks import (FFN, FeatureExtractor, FFMCell, Memoroid,
...
torso = Stack(blocks=(ffm, ffn) * num_layers)
...
logger = Logger(
    [DashboardLogger(title="PPO FFM CartPole", total_timesteps=total_timesteps, name="PPO-FFM", env_id="gymnax::CartPole-v1")]
)

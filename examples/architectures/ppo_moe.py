...
from memorax.networks import (FFN, RNN, FeatureExtractor, MoE, Network,
...
logger = Logger(
    [DashboardLogger(title="PPO MoE CartPole", total_timesteps=total_timesteps, name="PPO-MoE", env_id="gymnax::CartPole-v1")]
)

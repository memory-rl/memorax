...
from memorax.networks import (FFN, FeatureExtractor, Memoroid, Network,
                              PreNorm, Residual, Stack, heads, mLSTMCell)
...
logger = Logger(
    [DashboardLogger(title="PPO xLSTM CartPole", total_timesteps=total_timesteps, name="PPO-xLSTM", env_id="gymnax::CartPole-v1")]
)

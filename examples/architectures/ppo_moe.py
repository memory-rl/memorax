"""PPO on CartPole with Mixture of Experts (MoE) architecture.

This example demonstrates using a Mixture of Experts with:
- Multiple GRU-based expert networks for horizontal scaling
...
torso = Stack(blocks=(moe, ffn) * num_layers)
...
logger = Logger(
    [DashboardLogger(title="PPO MoE CartPole", total_timesteps=total_timesteps)]
)
